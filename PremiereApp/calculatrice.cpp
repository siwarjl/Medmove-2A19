...
{
    ui->setupUi(this);
   ui->display->setValidator(new QIntValidator(0,999999999999999999999999999999999999999999999999999999999999999999, this));
    // Put 0.0 in Display
...
void calculatrice:: EqualButtonPressed(){
    ...
    if(addTrigger || subTrigger || multTrigger || divTrigger ){
        if(addTrigger){
            ...
            // solution = calcVal + dblDisplayVal + dblDisplayVal ;
        } else if(subTrigger){
            solution = calcVal - dblDisplayVal ;
        } else if(multTrigger){
            solution = calcVal * dblDisplayVal ;
