...
void Ambulance::on_pushButton_21_clicked()
{
    QString matricule = ui->lineEdit_matricule->text();
        QString marque = ui->marque->text();
       QString datec = ui->date->text();
...
void Ambulance::on_pushButton_28_clicked()
{
    ...
    Ambulancec a(matricule,marque,datec,dispo,etat,img);
                    ...
                    if(test)
                        ...
                        QString nomFile ="histo";
                                                 ...
                                                 txt << message2;
                                    historique h;
                                    h.enregistrer_txt1(ui->lineEdit_matricule->text(),marque,datec,ui->dispo->currentText(),etat);
                               ui->historique->setText(h.imprimer_hist());
                        ui->view->setModel( a.afficher());
...
void Ambulance::on_pushButton_26_clicked()
{
...
void Ambulance::on_pushButton_25_clicked()
{
    Ambulancec s;
        ...
        printer.setOutputFileName("C:/Users/abeja/Documents/ambulances.pdf");  //nom du fichier
        ...
        // Dessiner le logo
        painter.drawPixmap(QRect(0, -45, 200, 200), QPixmap("C:/Users/abeja/Documents/logo.png"));
